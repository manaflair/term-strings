...
describe(`TermString`, () => {
    ...
    describe(`#padStart()`, () => {
        ...
        it(`can pad using a term string`, () => {
            ...
            expect(string.padStart(20, new TermStringBuilder().pushStyle({ emboldened: style.emboldened }).pushText(`x`).pushStyle({ emboldened: null }).pushText(`y`).build())).to.deep.equal(new TermStringBuilder().pushStyle({ emboldened: style.emboldened }).pushText(`x`).pushStyle({ emboldened: null }).pushText(`y`).pushStyle({ emboldened: style.emboldened }).pushText(`x`).pushStyle({ emboldened: null }).pushText(`y`).pushText(`hello`).pushStyle({ emboldened: style.emboldened }).pushText(`foo`).pushStyle({ italic: style.italic }).pushStyle({ emboldened: null }).pushText(`bar`).pushStyle({ italic: null }).pushText(`world`).build());
    ...
    describe(`#padEnd()`, () => {
        ...
        it(`can pad using a term string`, () => {
            ...
            expect(string.padEnd(20, new TermStringBuilder().pushStyle({ emboldened: style.emboldened }).pushText(`x`).pushStyle({ emboldened: null }).pushText(`y`).build())).to.deep.equal(new TermStringBuilder().pushText(`hello`).pushStyle({ emboldened: style.emboldened }).pushText(`foo`).pushStyle({ italic: style.italic }).pushStyle({ emboldened: null }).pushText(`bar`).pushStyle({ italic: null }).pushText(`world`).pushStyle({ emboldened: style.emboldened }).pushText(`x`).pushStyle({ emboldened: null }).pushText(`y`).pushStyle({ emboldened: style.emboldened }).pushText(`x`).pushStyle({ emboldened: null }).pushText(`y`).build());
